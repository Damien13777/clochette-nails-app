/**
 * /admin/newsletter/campagnes/new — Création d'une nouvelle campagne (DRAFT).
 */
...
import { CampaignForm } from "../[id]/campaign-form";

export const metadata: Metadata = {
  title: "Nouvelle campagne · Admin",
  ...
  return (
    <div className="max-w-[900px] px-5 lg:px-8 py-10 space-y-8">
      ...
      <header>
        ...
        >
          La campagne sera créée en brouillon. Tu pourras ensuite envoyer un
          test, programmer ou lancer l&apos;envoi.
        </p>
      </header>
