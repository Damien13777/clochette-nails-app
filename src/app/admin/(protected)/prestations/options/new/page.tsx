/**
 * /admin/prestations/options/new — création d'une option supplémentaire.
 */
  ...
  return (
    <div className="max-w-[900px] px-5 lg:px-8 py-10 space-y-8">
      ...
      <header>
        ...
        >
          Nouvelle option supplémentaire
        </h1>
        <p
          className="mt-2 text-sm text-[var(--color-ink-500)]"
          style={{ fontFamily: "var(--font-ui)" }}
        >
          Sera créée en brouillon. Tu pourras la publier après vérification.
        </p>
      </header>
